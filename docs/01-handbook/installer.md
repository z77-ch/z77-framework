...
<?php
// Auto-generated by Z77 Core Installer
// ABS_BASE_PATH, not dirname(__DIR__): __DIR__ resolves symlinks, so a
// symlinked config/ would anchor these paths in the link target's tree
// (the release layout does exactly that — see release-structure.md).
$vendorDir = ABS_BASE_PATH.'/vendor/';
$baseDir   = ABS_BASE_PATH.'/';
