...
/**
 * Layout config for a host that mounts the Mahnstufen fragment (ADR-018
 * pattern, the tax-code / chart model): the host's
 * `Ui/Config/Finance/dunningLevelControllerConfig.inc.php` delegates here (one line) and pins the
 ...
 */
final class DunningLevelLayout
{
        ...
        return [
            'levelElements' => [
                'body' => [
                    'main' => [[
                        'nameSpace' => self::NS,
                        'path'      => 'Backend/DunningLevelController',
                        'name'      => 'listAction',
                    ]],
                ],
            ],
