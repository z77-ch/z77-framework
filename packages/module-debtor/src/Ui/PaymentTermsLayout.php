...
/**
 * Layout config for a host that mounts the Zahlungskonditionen fragment (ADR-018
 * pattern, the tax-code / chart model): the host's
 * `Ui/Config/Finance/paymentTermsControllerConfig.inc.php` delegates here (one line) and pins the
 ...
 */
final class PaymentTermsLayout
{
        ...
        return [
            'levelElements' => [
                'body' => [
                    'main' => [[
                        'nameSpace' => self::NS,
                        'path'      => 'Backend/PaymentTermsController',
                        'name'      => 'listAction',
                    ]],
                ],
            ],
